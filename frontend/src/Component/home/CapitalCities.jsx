...
//   // ✅ Start with all capitals showing 0 — never hide any
//   const [cities, setCities] = useState(
//     CAPITALS.map(c => ({ ...c, count: 0, countLoaded: false }))
//   );
//   const [scrollIndex, setScrollIndex] = useState(0);

//   useEffect(() => {
//     // Fetch counts in background — update each city as count arrives
...
//             ? result.data.total
//             : 0;
//           // ✅ Update just this city's count — others stay visible
//           setCities(prev =>
//             prev.map((c, idx) =>
...
//     navigate(`/destinations/${city.toLowerCase().replace(" ", "-")}`);
//   };

//   const canPrev = scrollIndex > 0;
//   const canNext = scrollIndex + VISIBLE < cities.length;
//   const visibleCities = cities.slice(scrollIndex, scrollIndex + VISIBLE);
...
//             <button
//               onClick={() => setScrollIndex(i => Math.max(i - 1, 0))}
//               disabled={!canPrev}
...
//                   : isDarkMode ? "border-slate-800 text-slate-700 cursor-not-allowed" : "border-gray-100 text-gray-300 cursor-not-allowed"
//               }`}
//             >
//               <FiChevronLeft className="w-4 h-4" />
//             </button>
//             <button
//               onClick={() => setScrollIndex(i => Math.min(i + 1, cities.length - VISIBLE))}
//               disabled={!canNext}
//               className={`w-9 h-9 rounded-full border flex items-center justify-center transition-all duration-200 ${
//                 canNext
//                   ? isDarkMode ? "border-slate-600 text-white hover:bg-slate-800" : "border-gray-300 text-gray-700 hover:bg-gray-50"
...
//                   {countLoaded ? `${count} Stays` : "Loading..."}
//                 </p>
//               </div>
//             </button>
//           ))}
...
//           {Array.from({ length: cities.length - VISIBLE + 1 }).map((_, i) => (
//             <button
//               key={i}
