        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center divide-y lg:divide-y-0 lg:divide-x divide-gray-200 dark:divide-gray-700">
          ...
          <div className="px-4 py-2 flex items-center justify-center">
            ...
            <button
              ...
              className="w-full md:w-auto flex items-center justify-center gap-2 h-11 px-6 rounded-xl bg-[#FF385C] hover:bg-[#E31C5F] text-white font-semibold text-base shadow-md hover:shadow-lg transition-all duration-300 whitespace-nowrap"
