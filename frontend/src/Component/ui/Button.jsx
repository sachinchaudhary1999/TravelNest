...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-brand-red hover:bg-brand-red-hover text-white shadow-sm hover:shadow-lg focus:ring-brand-red/20',
    ...
    outline: 'border border-brand-red text-brand-red hover:bg-brand-red hover:text-white focus:ring-brand-red/20',
